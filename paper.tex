...
En síntesis:
  ...
  \item El simulador del norte de México y los materiales publicados en https://github.com/Selenofilia/OptimizaciOn-Multicriterio-de-Trayecto-y-Estrategias-de-Carga-en-Transporte-Ferroviario- permiten reproducir rankings, validación y ANOVA del estudio.
\subsubsection*{}
...
\paragraph{}
\textbf{Disponibilidad de software y datos. }El simulador del norte de México (SIMULADOR\_TOPSIS.html), el manuscrito (paper.tex), los datasets del experimento y las rutinas de reproducibilidad están disponibles en https://github.com/Selenofilia/OptimizaciOn-Multicriterio-de-Trayecto-y-Estrategias-de-Carga-en-Transporte-Ferroviario-, versión v1.0-paper. Los rankings del corredor norte se regeneran con scripts/run\_topsis\_analysis.py; el ANOVA factorial 3\textsuperscript{3} y el factorial mixto 9×3, con scripts/run\_factorial\_experiment.py. El experimento reportado emplea el subconjunto núcleo de 587 estrategias; el bundle de 4235 registros embebido en el simulador amplía la exploración interactiva sin redefinir el universo analítico del artículo.
